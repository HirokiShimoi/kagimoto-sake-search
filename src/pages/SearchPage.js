...
const SearchPage = () => {
    ...
    const [minPrice, setMinPrice] = useState(0); //最低価格
    const [maxPrice, setMaxPrice] = useState(0); //最高価格
                        ...
                        <tr>
                            ...
                            <td>
                                <div className="price-en">
                                    <input type="text" id="minPriceInput" value={minPrice} onChange={handleMinPriceChange} />
                                    <div>￥</div>
                                </div>
                                <span className="from-to">~</span>
                                <div className="price-en">
                                    <input type="text" id="maxPriceInput" value={maxPrice} onChange={handleMaxPriceChange} />
                                    <div>￥</div>
                                </div>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td>
                                <ul className="input-wrapper">
                                    <li className="category-selecter">
